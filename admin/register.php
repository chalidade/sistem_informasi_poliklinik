	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" method="post" action="proses/register.php">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Name is required">
						<input class="input100" type="text" name="nama" placeholder="Your Name">
          ...
          <div class="wrap-input100 validate-input m-b-16" data-validate = "Phone Number is required">
						<input class="input100" type="text" name="hp" placeholder="Your Phone Number">
						<span class="focus-input100"></span>
					</div>
          ...
          <div class="wrap-input100 validate-input m-b-16" data-validate = "Re Password is required">
						<input class="input100" type="password" name="re-pass" placeholder="Re Enter Password"  id="confirm_password">
						<span class="focus-input100"></span>
					</div>
